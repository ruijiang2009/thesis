...
def get_nouns(session, user_id='ikm0UCahtK34LbLCEw4YTw'):
    reviews = session.query(Review).filter(Review.user_id==user_id)
    words = []
...
dictionary_path = '/Users/ruijiang/thesis/analysis/dictionary/ikm0UCahtK34LbLCEw4YTw.dict'
corpus_path = '/Users/ruijiang/thesis/analysis/corpus/ikm0UCahtK34LbLCEw4YTw-corpus.lda-c'
lda_model_path = '/Users/ruijiang/thesis/analysis/model/ikm0UCahtK34LbLCEw4YTw-lda_model_20_topics.lda'
lda_num_topics = 20
